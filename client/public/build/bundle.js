...
var app = (function () {
    ...
    */
    ...
    var config_1 = {
        domainaddress: 'http://127.0.0.1:8080'
    };
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 19, 8, 605);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file, 20, 8, 650);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 25, 8, 769);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link0, file, 10, 2, 280);
    			attr_dev(link1, "rel", "stylesheet");
    			attr_dev(link1, "href", "bootstrap-icons-1.7.2/bootstrap-icons.css");
    			add_location(link1, file, 11, 2, 348);
    			attr_dev(div0, "class", "row");
    			add_location(div0, file, 15, 2, 470);
    			attr_dev(div1, "class", "col-5");
    			add_location(div1, file, 17, 4, 559);
    			attr_dev(div2, "class", "col-5");
    			add_location(div2, file, 23, 4, 723);
    			attr_dev(div3, "class", "row justify-content-evenly");
    			add_location(div3, file, 16, 2, 514);
    			attr_dev(div4, "class", "container-flex");
    			add_location(div4, file, 14, 0, 439);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
