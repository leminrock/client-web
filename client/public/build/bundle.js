...
var app = (function () {
    ...
    */
    ...
    var config_1 = {
        domainaddress: 'http://127.0.0.1:8000'
    };
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(31:8) {#if singolo.inUseBoolean}",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(30:6) {#each mbuto as singolo}",
    		ctx
    	});
    ...
    function create_header_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$4, 27, 4, 636);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			create_component(accordionitem.$$.fragment);
    			add_location(main, file$4, 25, 0, 607);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		fetch(`${config_1.domainaddress}/api/v1/wifi`).then(response => response.json()).then(data => {
    			console.log(data);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$2.warn(`<WifiList> was created with unknown prop '${key}'`);
    	});
    ...
    function create_header_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "slot", "header");
    			attr_dev(h2, "class", "grey");
    			add_location(h2, file$2, 35, 4, 770);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			create_component(accordionitem.$$.fragment);
    			add_location(main, file$2, 33, 0, 741);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		fetch(`${config_1.domainaddress}/api/v1/patch`).then(response => response.json()).then(data => {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<PatchList> was created with unknown prop '${key}'`);
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 38, 6, 966);
    			add_location(br, file$1, 39, 6, 1015);
    			attr_dev(input1, "type", "submit");
    			add_location(input1, file$1, 40, 6, 1028);
    			add_location(form, file$1, 37, 4, 915);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, form, anchor);
    ...
    function create_header_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "slot", "header");
    			attr_dev(h2, "class", "grey");
    			add_location(h2, file$1, 36, 4, 862);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			create_component(accordionitem.$$.fragment);
    			add_location(main, file$1, 34, 0, 833);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const submitForm = () => {
    		...
    		fetch(`${config_1.domainaddress}/api/v1/patch/upload`, {
    			method: "POST",
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<UpdatePatch> was created with unknown prop '${key}'`);
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 19, 8, 599);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file, 20, 8, 644);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 25, 8, 763);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link0, file, 10, 2, 274);
    			attr_dev(link1, "rel", "stylesheet");
    			attr_dev(link1, "href", "bootstrap-icons-1.7.2/bootstrap-icons.css");
    			add_location(link1, file, 11, 2, 342);
    			attr_dev(div0, "class", "row");
    			add_location(div0, file, 15, 2, 464);
    			attr_dev(div1, "class", "col-5");
    			add_location(div1, file, 17, 4, 553);
    			attr_dev(div2, "class", "col-5");
    			add_location(div2, file, 23, 4, 717);
    			attr_dev(div3, "class", "row justify-content-evenly");
    			add_location(div3, file, 16, 2, 508);
    			attr_dev(div4, "class", "container-flex");
    			add_location(div4, file, 14, 0, 433);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
