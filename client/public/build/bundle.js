...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 5, 4, 52);
    			attr_dev(a, "href", "https://github.com/leminrock");
    			add_location(a, file$3, 7, 14, 90);
    			add_location(p, file$3, 6, 4, 72);
    			attr_dev(main, "class", "svelte-u9qvfs");
    			add_location(main, file$3, 4, 0, 41);
    		},
    ...
    const file$2 = "src/Network.svelte";
    ...
    const file$1 = "src/Hotspot.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(strong, file$1, 4, 3, 47);
    ...
    const file = "src/WifiList.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(28:2) {#each mbuto as singolo}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 25, 1, 465);
    			add_location(ul, file, 26, 1, 495);
    			add_location(main, file, 24, 0, 457);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
