...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 5, 4, 52);
    			attr_dev(a, "href", "https://github.com/leminrock");
    			add_location(a, file$4, 7, 14, 90);
    			add_location(p, file$4, 6, 4, 72);
    			attr_dev(main, "class", "svelte-u9qvfs");
    			add_location(main, file$4, 4, 0, 41);
    		},
    ...
    /* src/Network.svelte generated by Svelte v3.44.3 */

    const file$3 = "src/Network.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			p = element("p");
    			p.textContent = "Linux Embedded Music";
    			add_location(p, file$3, 3, 6, 26);
    ...
    const file$2 = "src/Hotspot.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*hotname*/ ctx[0]);
    			add_location(strong, file$2, 4, 0, 41);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*hotname*/ 1) set_data_dev(t, /*hotname*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ('hotname' in $$props) $$invalidate(0, hotname = $$props.hotname);
    	};

    	$$self.$capture_state = () => ({ hotname });
    ...
    class Hotspot extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { hotname: 0 });
    		...
    		if (/*hotname*/ ctx[0] === undefined && !('hotname' in props)) {
    			console.warn("<Hotspot> was created without expected prop 'hotname'");
    		}
    	}
    ...
    const file$1 = "src/WifiList.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	hotspot = new Hotspot({
    			props: { hotname: /*singolo*/ ctx[1].SSID },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$1, 33, 8, 763);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			mount_component(hotspot, li, null);
    			append_dev(li, t);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const hotspot_changes = {};
    			if (dirty & /*mbuto*/ 1) hotspot_changes.hotname = /*singolo*/ ctx[1].SSID;
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(hotspot.$$.fragment);
    			t = space();
    			attr_dev(li, "class", "list-group-item active");
    			add_location(li, file$1, 29, 8, 646);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			mount_component(hotspot, li, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(29:6) {#if singolo.inUseBoolean}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(28:4) {#each mbuto as singolo}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Available Hotspots";
    			t1 = space();
    			ul = element("ul");
    			...
    			add_location(h1, file$1, 25, 2, 522);
    			attr_dev(ul, "class", "list-group");
    			add_location(ul, file$1, 26, 2, 552);
    			add_location(main, file$1, 24, 0, 513);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<WifiList> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ Hotspot, onMount, mbuto });
    ...
    function create_fragment(ctx) {
    	...
    	let wifilist;
    	let current;
    	welcome = new Welcome({ props: { name: "LEM" }, $$inline: true });
    	network = new Network({ props: { name: "lem" }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file, 7, 2, 161);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Welcome, Network, WifiList });
    	return [];
    }
